...
describe("RUNE protocol parse", function()
    it("builds a model from a BEGIN…END push", function()
        ...
        NS.RE_HandleLine(s, "RUNE~4~7000001~spell_arcane_studentofmagic~Regeneration")
        NS.RE_HandleLine(s, "RUNE~4~7000002~spell_arcane_arcane03~Mass Regeneration")
    ...
    it("captures a MSG status and defaults a missing icon", function()
        ...
        NS.RE_HandleLine(s, "RUNE~8~7000003~~Some Rune")
    ...
    it("preserves a rune name that contains the separator", function()
        ...
        NS.RE_HandleLine(s, "RUNE~0~123~some_icon~Odd~Name")
